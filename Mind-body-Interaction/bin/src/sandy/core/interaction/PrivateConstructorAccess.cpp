...
{
	Static(__mClass) = hx::RegisterClass(HX_STRING(L"sandy.core.interaction.PrivateConstructorAccess",47), hx::TCanCast< PrivateConstructorAccess_obj> ,sStaticFields,sMemberFields,
