...
class Socket_obj : public hx::Object{
	...
	public:
		...
		void __Mark();
		::String __ToString() const { return HX_STRING(L"Socket",6); }
		...
		static Dynamic select( Array< ::cpp::net::Socket > read,Array< ::cpp::net::Socket > write,Array< ::cpp::net::Socket > others,double timeout);
