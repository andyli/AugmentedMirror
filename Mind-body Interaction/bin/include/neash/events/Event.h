...
class Event_obj : public hx::Object{
	...
	public:
		...
		void __Mark();
		::String __ToString() const { return HX_STRING(L"Event",5); }
		...
		::String type; /* REM */ 
		bool mIsCancelled; /* REM */ 
		bool mIsCancelledNow; /* REM */ 
		virtual ::neash::events::Event clone( );
		Dynamic clone_dyn();

		virtual Void SetPhase( int inPhase);
		Dynamic SetPhase_dyn();
		...
		Dynamic IsCancelled_dyn();

		virtual bool IsCancelledNow( );
		Dynamic IsCancelledNow_dyn();
