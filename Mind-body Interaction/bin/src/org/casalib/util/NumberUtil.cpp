...
int NumberUtil_obj::randomIntegerWithinRange( int min,int max){
	__SAFE_POINT
	return ::Math_obj::round((min + ((::Math_obj::random() * ((max - min))))));
}
...
double NumberUtil_obj::interpolate( ::org::casalib::math::Percent amount,double begin,double end){
